EN: Official node modules in README.md, this rep for developers without PC, they can't install some packs using npm command. Skip replace of existing files.
